    ...
    emit(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const { data: result } = yield axios_1.default.request({
                ...
                data: json_bigint_1.default.stringify(data)
            });
...
function makeBuildInfo(startedAt, endedAt, status) {
    ...
    if (status === 'cancelled')
        ...
        jobStatus = lodash_1.startCase(lodash_1.camelCase(status));
    return {
        uid: id,
        number,
        name,
